...
module.exports = function (grunt) {
            ...
            main: {
                files: [
                    {expand: true, src: [
                        ...
                        'app/bower_components/requirejs-domready/*',
    ...
    grunt.registerTask("default", ["clean", "typescript:base", "sass:dist", "htmlmin", "concat", "replace", "uglify", "copy:main"]);
    grunt.registerTask("dev", ["typescript:dev", "sass:dev", "serve", "watch"]);
};
